                    ...
                    <div className="flex justify-between mt-1 px-1">
                        {[
                            ...
                            <div className="flex gap-3 pt-4">
                                ...
                                <button onClick={handleSaveEvent} className="flex-1 bg-blue-500 text-white py-3 rounded-xl font-bold shadow-lg hover:bg-lyvo-primary/90 active:bg-lyvo-primary/80 transition">Salvar</button>
                            </div>
                        </div>
                    </div>
                </div>
