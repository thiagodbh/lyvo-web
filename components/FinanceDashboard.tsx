                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-lyvo-primary p-4 rounded-2xl shadow-md border-l-4 border-blue-300 text-white flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-2xl font-bold mt-1 text-blue-600">{formatCurrency(balanceData.balance)}</p>
                        </div>
                    </div>
                </div>
    ...
    <Edit2 className="w-4 h-4" />
                                ...
                                {sortedBills.length > 4 && (
                                    <button 
                                        ...
                                        className="w-full py-2 text-lyvo-primary text-xs font-blue uppercase tracking-widest hover:bg-gray-50 rounded-xl transition-all"
                                    >
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100 mt-2">
                        ...
                        <button 
                            ...
                            className={`w-10 h-6 rounded-full p-1 transition-colors ${isRecurring ? 'bg-green-500' : 'bg-red-500'}`}
                        >
