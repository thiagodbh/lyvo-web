...
import AccessGuard from './components/AccessGuard'; // Importação do novo porteiro
...
function App() {
  ...
  React.useEffect(() => {
    const unsubscribe = authService.onChange(async (u) => {
      ...
      // O AccessGuard cuidará do store.setUser agora para garantir que os dados salvem
